...
response = requests.get("https://jobs.dicoding.com/list")
...
def auto_Scrapper(html_tag,course_case):
  for i in range(1,20):
    url = "https://jobs.dicoding.com/list?page=" +str(i) 
...
def auto_Scrapper_Class(html_tag,job_case,tag_class):
...
auto_Scrapper_Class('div',job_title,'CardJobs_title__zmEq1')
...
courses_df.to_csv('Dicoding.csv')
